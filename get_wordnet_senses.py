...
def main(wndb_path, output_path, train_frac, remove_non_char=False):
...
if __name__ == '__main__':
    ...
    aparser.add_argument(
        '--train_frac', type=float, default=0.90, help='fraction of lemmas in training')
    aparser.add_argument(
    ...
    main(
        opt.wndb_path, opt.output_path, opt.train_frac, opt.remove_non_char)
